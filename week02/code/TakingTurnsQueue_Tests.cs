...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: run test error - Expected:<Bob>. Actual:<Sue>. In PersonQueue.cs the function Enqueue added the person to the front or position 0.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Run Test Error - Expected:<Bob>. Actual:<Sue>. In TakingTurnsQueue.cs in GetNextPerson it did not account for the case of forever turns.
    ...
    // Defect(s) Found: Run Test Error Expected:<Tim>. Actual:<Sue>. In TakingTurnsQueue.cs in GetNextPerson it did not account for the case of forever turns.
